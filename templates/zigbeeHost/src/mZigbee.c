...
uint8_t zShortAddr(uint8_t* ieeeAddress, uint8_t requestType, uint8_t startIndex)
{
    ...
    zmBuf[12] = startIndex;
    USART_SendData(USART1,zmBuf[0]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[1]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[2]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[3]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[4]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[5]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[6]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[7]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[8]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[9]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[10]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[11]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[12]);
    mWait(2000);
    USART_SendData(USART1,zmBuf[13]);
    mWait(2000);
    while(USART_GetFlagStatus(USART1,USART_FLAG_TXE) == RESET);
    // zHexPrintf(zmBuf[0],1);
    // zHexPrintf(zmBuf[1],1);
    // zHexPrintf(zmBuf[2],1);
    // zHexPrintf(zmBuf[3],1);
    // zHexPrintf(zmBuf[4],1);
    // zHexPrintf(zmBuf[5],1);
    // zHexPrintf(zmBuf[6],1);
    // zHexPrintf(zmBuf[7],1);
    // zHexPrintf(zmBuf[8],1);
    // zHexPrintf(zmBuf[9],1);
    // zHexPrintf(zmBuf[10],1);
